...
<body>
    <div class="bg-gray-300 h-screen flex items-center justify-center">
        <section class="text-gray-600 body-font relative">
            <div class="container px-6 py-9 mx-auto w-setup bg-white rounded-lg drop-shadow-2xl">
                        ...
                        <div class="w-full">
                            <form action="{{ route('setup') }}" method="post">
                                ...
                                <div class="p-2 w-full">
                                    <button type="submit"
                                        class="flex mx-auto text-white bg-indigo-600 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-500 rounded text-lg">Setup</button>
                                </div>
